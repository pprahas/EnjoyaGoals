...
const About = () => {
  return (
    <div className="container">
      <img src="logo.png" alt="logo" className="AboutCenter" style={{ textAlign:"center" }}></img>
      {/* border: "1px red solid", */}
        <div style={{textAlign: "center", marginTop: 170, fontSize: 18, width: "100%", marginLeft: 80}}>
        
          <h2 className="textColor">
          <b style={{fontSize: 20, marginBottom: 10}}>Purpose:</b>
          </h2>
      ...
      <div style={{ textAlign: "center", marginTop: 80, fontSize: 18, width: "100%", marginLeft: 80 }}>
        <h2 className="textColor"><b style={{fontSize: 20}}>Our Developers:</b></h2>
        <p>
