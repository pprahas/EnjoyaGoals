...
const MainPost = (props) => {
    ...
    return (
        <article className="w-fit p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 mb-11">
            ...
            {comments.length == 1 && <p className="text-gray-900 dark:text-gray-400"> 1 Comment </p>}
            {comments.length != 1 && <p className="text-gray-900 dark:text-gray-400"> {comments.length} Comments </p>}
